...
def run_skool2html():
    options = "-c Config/InitModule={}:publish -d {}/build/html".format(SKOOLKIT_TOOLS, HOBBIT_HOME)
    art.tprint("The Hobbit")
    hex = '-H -c Config/GameDir=hobbit --var pub=2'
    dec = '-D -c Config/GameDir=hobbit/dec --var pub=4'
